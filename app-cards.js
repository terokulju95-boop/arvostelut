...
window.BUILD_CARDS = '2026-09-10.4';
...
function sectionSummaries(){
  ...
  return {
    ...
    logo:         (window.headerActionSummary ? window.headerActionSummary() : ''),
    ...
    etusivu:      (window.homeModCount ? window.homeModCount() : ''),
    tarkkuus:     ({ quick:'3 kysymystä', normal:'5 kysymystä', precise:'7 kysymystä' }[s.precision] || '5 kysymystä') +
                  (window.tieMode && window.tieMode() !== 'copy' ? ' · tasapeli muokattu' : ''),
