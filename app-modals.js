...
window.BUILD_MODALS = '2026-09-10.3';
...
window.openSettings = function(){
  ...
  safeRender('yläpalkin napit', window.renderHeaderSettings);
  safeRender('tasapeli', window.renderTieSettings);
  ...
  safeRender('kysymykset', window.renderDimSettings);
  ...
  safeRender('uutuuslista', window.renderWhatsNew);
  safeRender('uutuusmerkki', window.updateNewsBadge);
